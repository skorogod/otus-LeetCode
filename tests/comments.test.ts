...
// import { comments } from "../src/api/controllers/commentController";
...
//     const response = await request(app).patch("/comments/0").send(comment);
//     expect(response.statusCode).toBe(200);
//     expect(response.body).toEqual(comment);
//   });

//   test("It should send 404 status, after PATCH", async () => {
//     const response = await request(app).patch("/comments/3").send(comment);
//     expect(response.statusCode).toBe(404);
//   });

//   test("It should response body of request, after PUT", async () => {
//     const response = await request(app).put("/comments/0").send(comment);
//     expect(response.statusCode).toBe(200);
//     expect(response.body).toEqual(comment);
//   });

//   test("It should send 404 status, after PUT", async () => {
//     const response = await request(app).put("/comments/3").send(comment);
//     expect(response.statusCode).toBe(404);
//   });
