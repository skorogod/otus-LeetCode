...
// import { roles } from "../src/api/controllers/roleController";
...
//     const response = await request(app).post("/roles").send(role);
//     expect(response.statusCode).toBe(200);
//     expect(response.body).toEqual(role);
//   });

//   test("It should response body of request, after PATCH", async () => {
//     const response = await request(app).patch("/roles/0").send(role);
//     expect(response.statusCode).toBe(200);
//     expect(response.body).toEqual(role);
//   });

//   test("It should send 404 status, after PATCH", async () => {
//     const response = await request(app).patch("/roles/3").send(role);
//     expect(response.statusCode).toBe(404);
//   });

//   test("It should response body of request, after PUT", async () => {
//     const response = await request(app).put("/roles/0").send(role);
//     expect(response.statusCode).toBe(200);
//     expect(response.body).toEqual(role);
//   });

//   test("It should send 404 status, after PUT", async () => {
//     const response = await request(app).put("/roles/3").send(role);
//     expect(response.statusCode).toBe(404);
//   });
